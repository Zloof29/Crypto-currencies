...
window.onload = function chartCoin() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield fetch(`https://min-api.cryptocompare.com/data/pricemulti?fsyms=${toggleInput}&tsyms=USD`);
...
function handleLiveReportsButton() {
    const liveReportsButton = document.querySelector(`#liveReports`);
    const divCurrencyCards = document.querySelector(`#hideMe`);
    const divChart = document.querySelector(`#chartContainer`);
